...
const EditorCanvas = () => {
  ...
  const onNodesChange = useCallback(
    (changes: NodeChange[]) => {
      ...
      dispatch({
        type: "UPDATE_NODES_EDGES",
        payload: { elements: updatedNodes, edges },
      });
    },
  ...
  const onEdgesChange = useCallback(
    (changes: EdgeChange[]) => {
      ...
      dispatch({
        type: "UPDATE_NODES_EDGES",
        payload: { elements: nodes, edges: updatedEdges },
      });
    },
    [dispatch, nodes, edges]
  );
  ...
  const onConnect = useCallback(
    (params: Edge | Connection) => {
      ...
      dispatch({
        type: "UPDATE_NODES_EDGES",
        payload: { elements: nodes, edges: newEdges },
      });
    },
    [dispatch, nodes, edges]
  );
  ...
  const onDrop = useCallback(
    (event: React.DragEvent) => {
      ...
      const triggerAlreadyExists = nodes.find((node) => node.type === "Trigger");
      ...
      dispatch({
        type: "UPDATE_NODES_EDGES",
        payload: { elements: [...nodes, newNode], edges },
      });
    },
    [reactFlowInstance, nodes, edges, dispatch]
  );
